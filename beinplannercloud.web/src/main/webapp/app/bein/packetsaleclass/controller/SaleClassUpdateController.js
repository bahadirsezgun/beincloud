ptBossApp.controller('SaleClassUpdateController', function($rootScope,$scope,$translate,parameterService,$location,homerService,commonService,globals) {
	...
	$scope.saleUpdateClassProg=function(){
	...
	$scope.progCountChange=function(){
		$scope.saledPacket.packetPrice=$scope.programClass.progPrice*$scope.saledPacket.progCount ;
	}
