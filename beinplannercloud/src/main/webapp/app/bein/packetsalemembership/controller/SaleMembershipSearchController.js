ptBossApp.controller('SaleMembershipSearchController', function($rootScope,$scope,$translate,parameterService,$location,homerService,commonService) {
	...
	$scope.init = function(){
		...
		commonService.pageName=$translate.instant("saleMembershipSearchPage");
		commonService.pageComment=$translate.instant("saleMembershipSearchPageComment");
