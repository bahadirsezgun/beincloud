...
@Service
@Scope("prototype")
public class CalculatePersonalBonusToStatic implements CalculateService {
...
UserBonusObj userBonusObj=new UserBonusObj();
		...
		List<DefBonus> defBonuses= definitionService.findByUserIdAndBonusTypeAndBonusIsType(staffId, BonusTypes.BONUS_TYPE_PERSONAL, BonusTypes.BONUS_IS_TYPE_STATIC);
