ptBossApp.controller('PtCalendarWeekController', function($rootScope,$scope,$translate,parameterService,$location,homerService,commonService,globals) {
	...
	function getTimePlansForWeek(){
		...
		$.ajax({
			  type:'POST',
			  url: "../pt/schedule/searchTimePlansForStaffToWeek",
			  contentType: "application/json; charset=utf-8",				    
...
$( "div [name=tokenTimeWeek]" ).unbind("mouseover").bind("mouseover",function(){
			 ...
			 $("#infoDivWeek").css("position","absolute");
			 $("#infoDivWeek").html($(customInfo).html());
			 $("#infoDivWeek").css("top",top);
			 $("#infoDivWeek").css("left",left);
			 $("#infoDivWeek").css("text-align","center");
			 
			  $("#infoDivWeek").css("display","");
