ptBossApp.controller('FamilyProgController', function($rootScope,$scope,$translate,parameterService,$location,homerService,commonService,globals) {
		...
		$scope.deleteProgram =function(progId){
	        ...
	        function (isConfirm) {
	            if (isConfirm) {
	            	 ...
	            	 var frmDatum = {"progId":progId,'type':'pf'}; 
	       		   $.ajax({
	       			  type:'POST',
